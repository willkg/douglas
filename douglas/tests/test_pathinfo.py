...
class Testpathinfo(UnitTestBase):
    ...
    def test_dates_year(self):
        ...
        req = self.build_request(cfg=cfg, http={'PATH_INFO': '/2012'}, data={})
        blosxom_process_path_info(args={"request": req})
        expected = {
            'bl_type': 'entry_list',
            'pi_yr': '2012',
    ...
    def test_dates_month(self):
        ...
        req = self.build_request(
            cfg=cfg, http={'PATH_INFO': '/2012/02'}, data={})
        blosxom_process_path_info(args={"request": req})
        expected = {
            'bl_type': 'entry_list',
            'pi_yr': '2012',
    ...
    def test_dates_day(self):
        ...
        req = self.build_request(
            cfg=cfg, http={'PATH_INFO': '/2012/02/04'}, data={})
        blosxom_process_path_info(args={"request": req})
        expected = {
            'bl_type': 'entry_list',
            'pi_yr': '2012',
